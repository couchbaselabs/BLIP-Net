...
{
    internal sealed class BLIPWebSocketConnection : Connection
    {
        ...
        internal BLIPWebSocketConnection(WebSocket webSocket, Uri url, bool incoming)
            : base(incoming)
        {
            Socket = webSocket;
        ...
        {
            Socket = new WebSocket(Url.AbsoluteUri);
            SetupCallbacks();
            Socket.ConnectAsync();
        }
